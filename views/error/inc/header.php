...
<div class="container">
	<div id="header">
		...
		<ul class="nav nav-pills" >
			...
			<li role="presentation"><a href="<?php echo URL; ?>dashboard/logout">Logout</a></li>
			<?php else: ?>
				<?php if ($_SERVER["REQUEST_URI"] == '/login'): ?>
				<li role="presentation" class="active"><a href="<?php echo URL; ?>login">Login</a></li>
				<?php else: ?>
				<li role="presentation"><a href="<?php echo URL; ?>login">Login</a></li>
				<?php endif; ?>
			<?php endif; ?>
	    </ul>
